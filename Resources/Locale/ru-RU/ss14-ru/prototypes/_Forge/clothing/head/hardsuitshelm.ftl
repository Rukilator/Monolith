ent-ClothingHeadHelmetHardsuitSyndieSST = шлем кроваво-чёрного скафандра
    .desc = Тяжелобронированный шлем, предназначенный для элитных операций. Собственность Ударного подразделения Синдиката.
ent-ClothingHeadHealmetContractorStealh = шлем экзокостюма DCN™
    .desc = Прекрасно сидит на вашей голове фиксируя её положение
ent-ClothingHeadHelmetHardsuitContractor = шлем жёлто-чёрного скафандра DCN™
    .desc = Тяжелобронированный шлем, предназначенный для элитных операций.
ent-ClothingHeadHelmetHardsuitContractorEVA = шлем скафандра подрядчика EVA
