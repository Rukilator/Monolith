...
ent-AirlockGlassShuttleSyndicatePirateLocked = герметичный люк
    .desc = Он открывается, он закрывается, и он может вас раздавить.
ent-AirlockHatchCentComLocked = герметичный люк
    .desc = Он открывается, он закрывается, и он может вас раздавить.
ent-AirlockNfsdLockedLockedDebug = шлюз
ent-AirlockGlassShuttleNfsdLockedDebug = стыковочный шлюз
