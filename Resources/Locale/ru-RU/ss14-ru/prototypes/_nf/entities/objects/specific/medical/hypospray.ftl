...
ent-NFChemicalMedipen = автоинжектор гемостатика
    .desc = Быстрая доза коагулянтов и кровезаменителей. Содержит транексамовую кислоту и физраствор.
ent-PolyAutoInjector = автоинжектор полипирилиума
