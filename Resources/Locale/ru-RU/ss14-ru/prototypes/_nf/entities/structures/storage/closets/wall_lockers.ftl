...
ent-ClosetWallO2N2FilledRandom = { ent-ClosetO2N2 }
    .suffix = Заполненный, Случайно
    .desc = { ent-ClosetO2N2.desc }
ent-LockerWallColorL4Bomb = настенный шкаф для противоосколочного костюма L4
ent-LockerWallColorL1Fire = настенный шкаф для огнестойкого костюма L1
ent-LockerWallColorL3Biohazard = настенный шкаф для биозащитного костюма L3
ent-LockerWallColorL2Radiation = настенный шкаф для радиационного костюма L2
ent-NFPrisonerClosetWallOrange = настенный тюремный шкаф
